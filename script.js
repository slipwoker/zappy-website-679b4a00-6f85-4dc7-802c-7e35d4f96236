document.addEventListener('DOMContentLoaded', function () {
  ...
  function showFieldError(field, message) {
    ...
    const wrapper = field.closest('.form-group, .form-field, .input-wrapper') || field.parentNode;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "עורך דין יצחק גואטה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '679b4a00-6f85-4dc7-802c-7e35d4f96236',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '679b4a00-6f85-4dc7-802c-7e35d4f96236';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '679b4a00-6f85-4dc7-802c-7e35d4f96236';
